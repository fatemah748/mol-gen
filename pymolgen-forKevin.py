...
terminal_rxns = {'hydrogen': '[*:1]([Y])>>[*:1]([H])',
                 ...
                 'methoxy': '[*:1]([Y])>>[*:1]OC',
                 'ethoxy': '[*:1]([Y])>>[*:1]OCC',
                 'o-tertBu': '[*:1]([Y])>>[*:1]OC(C)(C)C',
                 'nitro': '[*:1]([Y])>>[*:1][N+]([O-])=O',
                 'sulfur-trioxide':'[*:1]([Y])>>[*:1]S([O-])(=O)=O',
                 'chloro': '[*:1]([Y])>>[*:1][Cl]',
                 'bromo': '[*:1]([Y])>>[*:1][Br]',
                 'iodo': '[*:1]([Y])>>[*:1][I]',
                 'phenyl':'[*:1]([Y])>>[*:1]C1=CC=CC=C1',
                 'ophenyl':'[*:1]([Y])>>[*:1]OC1=CC=CC=C1',
                 'benzyl': '[*:1]([Y])>>[*:1]CC1=CC=CC=C1',
                 'obenzyl': '[*:1]([Y])>>[*:1]OCC1=CC=CC=C1',
                 'cyano': '[*:1]([Y])>>[*:1]C#N'}
